...
│           ├── observer.py              # observer 触发器（兼容保留）
│           └── reflector.py             # reflector 触发器（兼容保留）
│
├── tools/
