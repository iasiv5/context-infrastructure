...
🟢 Low: [归档迁移] 08-06 15:37 一次大批量同时间戳的 adhoc_jobs/docs 文件变动为归档/merge 操作结果（LastWriteTime 统一刷新但 git status 显示非新增），observer 已按 git name-status 过滤为噪音，仅保留真正 `A` 新增的 4 篇文章与 main PR #84 的 3 个新文件。
